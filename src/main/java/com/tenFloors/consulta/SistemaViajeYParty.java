...
public class SistemaViajeYParty {

    private final Grafo<String> mapaMundo;
    private final Conjunto<Jugador> jugadoresOnline;

    public SistemaViajeYParty(Grafo<String> mapaMundo, Conjunto<Jugador> jugadoresOnline) {
        this.mapaMundo = mapaMundo;
        this.jugadoresOnline = jugadoresOnline;
    }

    // HITO 1: Verifica la ruta hacia la zona destino y arma una Party con los jugadores online.
